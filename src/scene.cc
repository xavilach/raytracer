...
Raytracer::Scene::Scene(std::string title, int width, int height)
...
void Raytracer::Scene::setPixel(int x, int y, const Vec3 &color)
{
    m_lock.lock();
    if (m_renderer)
    {
